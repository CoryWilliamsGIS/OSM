...
#THIS CARRIED ON FROM NAIROBI_COMPLETE_UNFORMATTED WARD SECTION

#calculate kernal bandwidth
library("spgwr")

gwrbandwidth.n_lm_osmuid <- gwr.sel(nairobi_join3$`Distinct osm_users` ~nairobi_join3$`total population`+  
...
gwrbandwidth.n_lm_police <- gwr.sel(nairobi_join3$Police ~nairobi_join3$`total population`+  
                                      ...
                                      nairobi_join3$pop_density, data =n_jointrial, adapt = T)
...
gwrbandwidth.n_lm_mosque <- gwr.sel(nairobi_join3$Mosque ~nairobi_join3$`total population`+  
                                       nairobi_join3$`general sex ratio (females to males)`+ 
                                       nairobi_join3$`% of primary school attendance (6-13)`+ 
                                       nairobi_join3$`Secondary School Attendance of 14- to 17-Year-Olds`+ nairobi_join3$`education level index`+ 
                                       nairobi_join3$`% households owning own livestock`+ nairobi_join3$`% pop 18-64`+ 
...
gwrbandwidth.n_lm_footway <- gwr.sel(nairobi_join3$Footway ~nairobi_join3$`total population`+  
                                      nairobi_join3$`general sex ratio (females to males)`+ 
                                      nairobi_join3$`% of primary school attendance (6-13)`+ 
                                      nairobi_join3$`Secondary School Attendance of 14- to 17-Year-Olds`+ nairobi_join3$`education level index`+ 
                                      nairobi_join3$`% households owning own livestock`+ nairobi_join3$`% pop 18-64`+ 
...
gwrbandwidth.n_lm_primary<- gwr.sel(nairobi_join3$Primary ~nairobi_join3$`total population`+  
                                      nairobi_join3$`general sex ratio (females to males)`+ 
                                      nairobi_join3$`% of primary school attendance (6-13)`+ 
                                      nairobi_join3$`Secondary School Attendance of 14- to 17-Year-Olds`+ nairobi_join3$`education level index`+ 
                                      nairobi_join3$`% households owning own livestock`+ nairobi_join3$`% pop 18-64`+ 
...
gwrbandwidth.n_lm_residential <- gwr.sel(nairobi_join3$Residential ~nairobi_join3$`total population`+  
                                      nairobi_join3$`general sex ratio (females to males)`+ 
                                      nairobi_join3$`% of primary school attendance (6-13)`+ 
                                      nairobi_join3$`Secondary School Attendance of 14- to 17-Year-Olds`+ nairobi_join3$`education level index`+ 
                                      nairobi_join3$`% households owning own livestock`+ nairobi_join3$`% pop 18-64`+ 
...
gwrbandwidth.n_lm_unclassified <- gwr.sel(nairobi_join3$Unclassified ~nairobi_join3$`total population`+  
                                      nairobi_join3$`general sex ratio (females to males)`+ 
                                      nairobi_join3$`% of primary school attendance (6-13)`+ 
                                      nairobi_join3$`Secondary School Attendance of 14- to 17-Year-Olds`+ nairobi_join3$`education level index`+ 
                                      nairobi_join3$`% households owning own livestock`+ nairobi_join3$`% pop 18-64`+ 
...
gwrmodel.n_lm_osmuid <- gwr(nairobi_join3$`Distinct osm_users` ~nairobi_join3$`total population`+  
                                  nairobi_join3$`general sex ratio (females to males)`+ 
                                  nairobi_join3$`% of primary school attendance (6-13)`+ 
                                  nairobi_join3$`Secondary School Attendance of 14- to 17-Year-Olds`+ nairobi_join3$`education level index`+ 
                                  nairobi_join3$`% households owning own livestock`+ nairobi_join3$`% pop 18-64`+ 
                                ...
                                data =n_jointrial, adapt = gwrbandwidth.n_lm_osmuid, hatmatrix=TRUE, se.fit=TRUE
)
...
gwrmodel.n_lm_totaledits <- gwr(nairobi_join3$`total edits` ~nairobi_join3$`total population`+  
                                  ...
                                  nairobi_join3$`% of households owning house they live in`+ nairobi_join3$`% Employment Rate`+ 
                                  nairobi_join3$`% access to safe water source`+ nairobi_join3$`% access to improved sanitation`+nairobi_join3$pop_density, 
                                data =n_jointrial, adapt = gwrbandwidth.n_lm_totaledits, hatmatrix=TRUE, se.fit=TRUE
)
...
gwrmodel.n_lm_line <- gwr(nairobi_join3$Line_Count ~nairobi_join3$`total population`+  
                            ...
                            nairobi_join3$`% of households owning house they live in`+ nairobi_join3$`% Employment Rate`+ 
                            nairobi_join3$`% access to safe water source`+ nairobi_join3$`% access to improved sanitation`+nairobi_join3$pop_density,
                          data =n_jointrial, adapt = gwrbandwidth.n_lm_line, hatmatrix=TRUE, se.fit=TRUE
)
...
gwrmodel.n_lm_polygon <- gwr(nairobi_join3$Polygon_Count ~nairobi_join3$`total population`+  
                               ...
                               nairobi_join3$`% of households owning house they live in`+ nairobi_join3$`% Employment Rate`+ 
                               nairobi_join3$`% access to safe water source`+ nairobi_join3$`% access to improved sanitation`+nairobi_join3$pop_density,
                             data =n_jointrial, adapt = gwrbandwidth.n_lm_polygon, hatmatrix=TRUE, se.fit=TRUE
)
...
gwrmodel.n_lm_ftdensity <- gwr(nairobi_join3$ft_density ~nairobi_join3$`total population`+  
                                 ...
                                 nairobi_join3$`% of households owning house they live in`+ nairobi_join3$`% Employment Rate`+ 
                                 nairobi_join3$`% access to safe water source`+ nairobi_join3$`% access to improved sanitation`+nairobi_join3$pop_density,
                               data =n_jointrial, adapt = gwrbandwidth.n_lm_ftdensity, hatmatrix=TRUE, se.fit=TRUE
)
...
gwrmodel.n_lm_school<- gwr(nairobi_join3$School ~nairobi_join3$`total population`+  
                             ...
                             nairobi_join3$`% of households owning house they live in`+ nairobi_join3$`% Employment Rate`+ 
                             nairobi_join3$`% access to safe water source`+ nairobi_join3$`% access to improved sanitation`+nairobi_join3$pop_density,
                           data =n_jointrial, adapt = gwrbandwidth.n_lm_school, hatmatrix=TRUE, se.fit=TRUE
)
...
gwrmodel.n_lm_college <- gwr(nairobi_join3$College ~nairobi_join3$`total population`+  
                               ...
                               nairobi_join3$`% of households owning house they live in`+ nairobi_join3$`% Employment Rate`+ 
                               nairobi_join3$`% access to safe water source`+ nairobi_join3$`% access to improved sanitation`+nairobi_join3$pop_density,
                             data =n_jointrial, adapt = gwrbandwidth.n_lm_college, hatmatrix=TRUE, se.fit=TRUE)
...
gwrmodel.n_lm_pub <- gwr(nairobi_join3$Pub ~nairobi_join3$`total population`+  
                           ...
                           nairobi_join3$`% of households owning house they live in`+ nairobi_join3$`% Employment Rate`+ 
                           nairobi_join3$`% access to safe water source`+ nairobi_join3$`% access to improved sanitation`+nairobi_join3$pop_density,
                         data =n_jointrial, adapt = gwrbandwidth.n_lm_pub, hatmatrix=TRUE, se.fit=TRUE)
...
gwrmodel.n_lm_bar <- gwr(nairobi_join3$Bar ~nairobi_join3$`total population`+  
                           ...
                           nairobi_join3$`% of households owning house they live in`+ nairobi_join3$`% Employment Rate`+ 
                           nairobi_join3$`% access to safe water source`+ nairobi_join3$`% access to improved sanitation`+nairobi_join3$pop_density,
                         data =n_jointrial, adapt = gwrbandwidth.n_lm_bar, hatmatrix=TRUE, se.fit=TRUE)
...
gwrmodel.n_lm_pharmacy <- gwr(nairobi_join3$Pharmacy ~nairobi_join3$`total population`+  
                                ...
                                nairobi_join3$`% of households owning house they live in`+ nairobi_join3$`% Employment Rate`+ 
                                nairobi_join3$`% access to safe water source`+ nairobi_join3$`% access to improved sanitation`+nairobi_join3$pop_density,
                              data =n_jointrial, adapt = gwrbandwidth.n_lm_pharmacy, hatmatrix=TRUE, se.fit=TRUE)
...
gwrmodel.n_lm_hospital <- gwr(nairobi_join3$Hospital ~nairobi_join3$`total population`+  
                                ...
                                nairobi_join3$`% of households owning house they live in`+ nairobi_join3$`% Employment Rate`+ 
                                nairobi_join3$`% access to safe water source`+ nairobi_join3$`% access to improved sanitation`+nairobi_join3$pop_density,
                              data =n_jointrial, adapt = gwrbandwidth.n_lm_hospital, hatmatrix=TRUE, se.fit=TRUE)
...
gwrmodel.n_lm_dentist <- gwr(nairobi_join3$Dentist ~nairobi_join3$`total population`+  
                               ...
                               nairobi_join3$`% of households owning house they live in`+ nairobi_join3$`% Employment Rate`+ 
                               nairobi_join3$`% access to safe water source`+ nairobi_join3$`% access to improved sanitation`+nairobi_join3$pop_density,
                             data =n_jointrial, adapt = gwrbandwidth.n_lm_dentist, hatmatrix=TRUE, se.fit=TRUE)
...
gwrmodel.n_lm_clinic <- gwr(nairobi_join3$Clinic ~nairobi_join3$`total population`+  
                              ...
                              nairobi_join3$`% of households owning house they live in`+ nairobi_join3$`% Employment Rate`+ 
                              nairobi_join3$`% access to safe water source`+ nairobi_join3$`% access to improved sanitation`+nairobi_join3$pop_density,
                            data =n_jointrial, adapt = gwrbandwidth.n_lm_clinic, hatmatrix=TRUE, se.fit=TRUE)
...
gwrmodel.n_lm_police <- gwr(nairobi_join3$Police ~nairobi_join3$`total population`+  
                              ...
                              nairobi_join3$`% of households owning house they live in`+ nairobi_join3$`% Employment Rate`+ 
                              nairobi_join3$`% access to safe water source`+ nairobi_join3$`% access to improved sanitation`+nairobi_join3$pop_density,
                            data =n_jointrial, adapt = gwrbandwidth.n_lm_police, hatmatrix=TRUE, se.fit=TRUE)

gwrmodel.n_lm_bank <- gwr(nairobi_join3$Bank ~nairobi_join3$`total population`+  
                                nairobi_join3$`general sex ratio (females to males)`+ 
                                nairobi_join3$`% of primary school attendance (6-13)`+ 
                                nairobi_join3$`Secondary School Attendance of 14- to 17-Year-Olds`+ nairobi_join3$`education level index`+ 
                                nairobi_join3$`% households owning own livestock`+ nairobi_join3$`% pop 18-64`+ 
                                ...
                                nairobi_join3$`% of households owning house they live in`+ nairobi_join3$`% Employment Rate`+ 
                                nairobi_join3$`% access to safe water source`+ nairobi_join3$`% access to improved sanitation`+nairobi_join3$pop_density,
                              data =n_jointrial, adapt = gwrbandwidth.n_lm_bank, hatmatrix=TRUE, se.fit=TRUE)
...
gwrmodel.n_lm_atm<- gwr(nairobi_join3$ATM ~nairobi_join3$`total population`+  
                          ...
                          nairobi_join3$`% of households owning house they live in`+ nairobi_join3$`% Employment Rate`+ 
                          nairobi_join3$`% access to safe water source`+ nairobi_join3$`% access to improved sanitation`+nairobi_join3$pop_density,
                        data =n_jointrial, adapt = gwrbandwidth.n_lm_atm, hatmatrix=TRUE, se.fit=TRUE)
...
gwrmodel.n_lm_restaurant <- gwr(nairobi_join3$Restaurant ~nairobi_join3$`total population`+  
                                  ...
                                  nairobi_join3$`% of households owning house they live in`+ nairobi_join3$`% Employment Rate`+ 
                                  nairobi_join3$`% access to safe water source`+ nairobi_join3$`% access to improved sanitation`+nairobi_join3$pop_density,
                                data =n_jointrial, adapt = gwrbandwidth.n_lm_restaurant, hatmatrix=TRUE, se.fit=TRUE)
...
gwrmodel.n_lm_fastfood <- gwr(nairobi_join3$`Fast Food` ~nairobi_join3$`total population`+  
                                ...
                                nairobi_join3$`% of households owning house they live in`+ nairobi_join3$`% Employment Rate`+ 
                                nairobi_join3$`% access to safe water source`+ nairobi_join3$`% access to improved sanitation`+nairobi_join3$pop_density,
                              data =n_jointrial, adapt = gwrbandwidth.n_lm_fastfood, hatmatrix=TRUE, se.fit=TRUE)
...
gwrmodel.n_lm_toilets <- gwr(nairobi_join3$Toilets~nairobi_join3$`total population`+  
                               ...
                               nairobi_join3$`% of households owning house they live in`+ nairobi_join3$`% Employment Rate`+ 
                               nairobi_join3$`% access to safe water source`+ nairobi_join3$`% access to improved sanitation`+nairobi_join3$pop_density,
                             data =n_jointrial, adapt = gwrbandwidth.n_lm_toilets, hatmatrix=TRUE, se.fit=TRUE)
...
gwrmodel.n_lm_drinkingwater <- gwr(nairobi_join3$`Drinking Water` ~nairobi_join3$`total population`+  
                                     ...
                                     nairobi_join3$`% of households owning house they live in`+ nairobi_join3$`% Employment Rate`+ 
                                     nairobi_join3$`% access to safe water source`+ nairobi_join3$`% access to improved sanitation`+nairobi_join3$pop_density,
                                   data =n_jointrial, adapt = gwrbandwidth.n_lm_drinkingwater, hatmatrix=TRUE, se.fit=TRUE)
...
gwrmodel.n_lm_placeofworship<- gwr(nairobi_join3$`Place of Worship` ~nairobi_join3$`total population`+  
                                     ...
                                     nairobi_join3$`% of households owning house they live in`+ nairobi_join3$`% Employment Rate`+ 
                                     nairobi_join3$`% access to safe water source`+ nairobi_join3$`% access to improved sanitation`+nairobi_join3$pop_density,
                                   data =n_jointrial, adapt = gwrbandwidth.n_lm_placeofworship, hatmatrix=TRUE, se.fit=TRUE)
...
gwrmodel.n_lm_busstop <- gwr(nairobi_join3$Bus_Stop ~nairobi_join3$`total population`+  
                               ...
                               nairobi_join3$`% of households owning house they live in`+ nairobi_join3$`% Employment Rate`+ 
                               nairobi_join3$`% access to safe water source`+ nairobi_join3$`% access to improved sanitation`+nairobi_join3$pop_density,
                             data =n_jointrial, adapt = gwrbandwidth.n_lm_busstop, hatmatrix=TRUE, se.fit=TRUE)
...
gwrmodel.n_lm_streetlamp <- gwr(nairobi_join3$`Street Lamp` ~nairobi_join3$`total population`+  
                                  ...
                                  nairobi_join3$`% of households owning house they live in`+ nairobi_join3$`% Employment Rate`+ 
                                  nairobi_join3$`% access to safe water source`+ nairobi_join3$`% access to improved sanitation`+nairobi_join3$pop_density,
                                data =n_jointrial, adapt = gwrbandwidth.n_lm_streetlamp, hatmatrix=TRUE, se.fit=TRUE)
...
gwrmodel.n_lm_hotel <- gwr(nairobi_join3$Hotel ~nairobi_join3$`total population`+  
                             ...
                             nairobi_join3$`% of households owning house they live in`+ nairobi_join3$`% Employment Rate`+ 
                             nairobi_join3$`% access to safe water source`+ nairobi_join3$`% access to improved sanitation`+nairobi_join3$pop_density,
                           data =n_jointrial, adapt = gwrbandwidth.n_lm_hotel, hatmatrix=TRUE, se.fit=TRUE)
...
gwrmodel.n_lm_industrial <- gwr(nairobi_join3$Industrial ~nairobi_join3$`total population`+  
                                  ...
                                  nairobi_join3$`% of households owning house they live in`+ nairobi_join3$`% Employment Rate`+ 
                                  nairobi_join3$`% access to safe water source`+ nairobi_join3$`% access to improved sanitation`+nairobi_join3$pop_density,
                                data =n_jointrial, adapt = gwrbandwidth.n_lm_industrial, hatmatrix=TRUE, se.fit=TRUE)
...
gwrmodel.n_lm_apartments <- gwr(nairobi_join3$Apartments ~nairobi_join3$`total population`+  
                                  ...
                                  nairobi_join3$`% of households owning house they live in`+ nairobi_join3$`% Employment Rate`+ 
                                  nairobi_join3$`% access to safe water source`+ nairobi_join3$`% access to improved sanitation`+nairobi_join3$pop_density,
                                data =n_jointrial, adapt = gwrbandwidth.n_lm_apartments, hatmatrix=TRUE, se.fit=TRUE)
...
gwrmodel.n_lm_house <- gwr(nairobi_join3$House ~nairobi_join3$`total population`+  
                             ...
                             nairobi_join3$`% of households owning house they live in`+ nairobi_join3$`% Employment Rate`+ 
                             nairobi_join3$`% access to safe water source`+ nairobi_join3$`% access to improved sanitation`+nairobi_join3$pop_density,
                           data =n_jointrial, adapt = gwrbandwidth.n_lm_house, hatmatrix=TRUE, se.fit=TRUE)
...
gwrmodel.n_lm_church <- gwr(nairobi_join3$Church ~nairobi_join3$`total population`+  
                              ...
                              nairobi_join3$`% of households owning house they live in`+ nairobi_join3$`% Employment Rate`+ 
                              nairobi_join3$`% access to safe water source`+ nairobi_join3$`% access to improved sanitation`+nairobi_join3$pop_density,
                            data =n_jointrial, adapt = gwrbandwidth.n_lm_church, hatmatrix=TRUE, se.fit=TRUE)
 ...
 gwrmodel.n_lm_mosque <- gwr(nairobi_join3$Mosque ~nairobi_join3$`total population`+  
                               ...
                               nairobi_join3$`% of households owning house they live in`+ nairobi_join3$`% Employment Rate`+ 
                               nairobi_join3$`% access to safe water source`+ nairobi_join3$`% access to improved sanitation`+nairobi_join3$pop_density,
                             data =n_jointrial, adapt = gwrbandwidth.n_lm_mosque, hatmatrix=TRUE, se.fit=TRUE)

gwrmodel.n_lm_footway <- gwr(nairobi_join3$Footway ~nairobi_join3$`total population`+  
                               nairobi_join3$`general sex ratio (females to males)`+ 
                               nairobi_join3$`% of primary school attendance (6-13)`+ 
                               nairobi_join3$`Secondary School Attendance of 14- to 17-Year-Olds`+ nairobi_join3$`education level index`+ 
                               nairobi_join3$`% households owning own livestock`+ nairobi_join3$`% pop 18-64`+ 
                               ...
                               nairobi_join3$`% of households owning house they live in`+ nairobi_join3$`% Employment Rate`+ 
                               nairobi_join3$`% access to safe water source`+ nairobi_join3$`% access to improved sanitation`+nairobi_join3$pop_density, 
                             data =n_jointrial, adapt = gwrbandwidth.n_lm_footway, hatmatrix=TRUE, se.fit=TRUE)

gwrmodel.n_lm_primary <- gwr(nairobi_join3$Primary ~nairobi_join3$`total population`+  
                               nairobi_join3$`general sex ratio (females to males)`+ 
                               nairobi_join3$`% of primary school attendance (6-13)`+ 
                               nairobi_join3$`Secondary School Attendance of 14- to 17-Year-Olds`+ nairobi_join3$`education level index`+ 
                               nairobi_join3$`% households owning own livestock`+ nairobi_join3$`% pop 18-64`+ 
                               ...
                               nairobi_join3$`% of households owning house they live in`+ nairobi_join3$`% Employment Rate`+ 
                               nairobi_join3$`% access to safe water source`+ nairobi_join3$`% access to improved sanitation`+nairobi_join3$pop_density, 
                             data =n_jointrial, adapt = gwrbandwidth.n_lm_primary, hatmatrix=TRUE, se.fit=TRUE)

gwrmodel.n_lm_residential <- gwr(nairobi_join3$Residential ~nairobi_join3$`total population`+  
                               nairobi_join3$`general sex ratio (females to males)`+ 
                               nairobi_join3$`% of primary school attendance (6-13)`+ 
                               nairobi_join3$`Secondary School Attendance of 14- to 17-Year-Olds`+ nairobi_join3$`education level index`+ 
                               nairobi_join3$`% households owning own livestock`+ nairobi_join3$`% pop 18-64`+ 
                               ...
                               nairobi_join3$`% of households owning house they live in`+ nairobi_join3$`% Employment Rate`+ 
                               nairobi_join3$`% access to safe water source`+ nairobi_join3$`% access to improved sanitation`+nairobi_join3$pop_density, 
                             data =n_jointrial, adapt = gwrbandwidth.n_lm_residential, hatmatrix=TRUE, se.fit=TRUE)

gwrmodel.n_lm_unclassified <- gwr(nairobi_join3$Unclassified ~nairobi_join3$`total population`+  
                               nairobi_join3$`general sex ratio (females to males)`+ 
                               nairobi_join3$`% of primary school attendance (6-13)`+ 
                               nairobi_join3$`Secondary School Attendance of 14- to 17-Year-Olds`+ nairobi_join3$`education level index`+ 
                               nairobi_join3$`% households owning own livestock`+ nairobi_join3$`% pop 18-64`+ 
                               ...
                               nairobi_join3$`% of households owning house they live in`+ nairobi_join3$`% Employment Rate`+ 
                               nairobi_join3$`% access to safe water source`+ nairobi_join3$`% access to improved sanitation`+nairobi_join3$pop_density, 
                             data =n_jointrial, adapt = gwrbandwidth.n_lm_unclassified, hatmatrix=TRUE, se.fit=TRUE)
